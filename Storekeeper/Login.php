 ...
 if( isset($_POST["submit"])){
   ...
   if( !empty($username) && !empty($password) ){
	 ...
	 $sql_query = "SELECT * FROM storekeeper";
...
<body>
	...
	<div class="header">
		<h1></h1>
        <a style="font-size:150%;"  href="../Admin/Login.php">Login As Admin</a>
    ...
    <form  method="POST" action="" >
        ...
        <input class="button" type="submit" name="submit" value="Login As Clerk">
